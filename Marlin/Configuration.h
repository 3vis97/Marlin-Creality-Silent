...
#define STRING_CONFIG_H_AUTHOR "(3vs, ASWX1 v1.0)" // Who made the changes.             // 3vs
#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)       // 3vs
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_GEN_L_V21                      // 3vs
#endif
 ...
 */
#define BAUDRATE 250000                                                        // 3vs

#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate         // 3vs
...
#define CUSTOM_MACHINE_NAME "Artillery Sidewinder X1"      // 3vs
 ...
 */
#define X_DRIVER_TYPE  TMC2209                             // 3vs
#define Y_DRIVER_TYPE  TMC2209                             // 3vs
#define Z_DRIVER_TYPE  TMC2209                             // 3vs
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209                             // 3vs
...
#define E0_DRIVER_TYPE TMC2209                             // 3vs
...
#define HEATER_0_MAXTEMP 275                               // 3vs
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 14.58                               // 3vs
    #define DEFAULT_Ki  1.14                               // 3vs
    #define DEFAULT_Kd 46.57                               // 3vs

    //#define DEFAULT_Kp  22.20                            // 3vs
    //#define DEFAULT_Ki   1.08                            // 3vs
    //#define DEFAULT_Kd 114.00                            // 3vs
  #endif
#else
 ...
 */
#define PIDTEMPBED                                         // 3vs

#if ENABLED(PIDTEMPBED)
  //#define MIN_BED_POWER 0
  //#define PID_BED_DEBUG // Print Bed PID debug data to the serial port.

  // Artillery Sidewinder X1                               // 3vs
  #define DEFAULT_bedKp 244.21                             // 3vs
  #define DEFAULT_bedKi  45.87                             // 3vs
  #define DEFAULT_bedKd 325.08                             // 3vs

  // 120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  //#define DEFAULT_bedKp 10.00                            // 3vs
  //#define DEFAULT_bedKi .023                             // 3vs
  //#define DEFAULT_bedKd 305.4                            // 3vs
 ...
 */
#define PREVENT_COLD_EXTRUSION                             // 3vs
...
#define X_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.           // 3vs
#define Y_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.           // 3vs
#define Z_MIN_ENDSTOP_INVERTING true  // Set to true to invert the logic of the endstop.           // 3vs: set to true due to usage of Z min endstop as probe
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe.        // 3vs: set to true due to usage of Z min endstop as probe
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2                          // 3vs
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 445 }         // 3vs
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 20, 40 }                     // 3vs: decreased values
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 10000 }               // 3vs
 ...
 */
#define DEFAULT_ACCELERATION          1000     // X, Y, Z and E acceleration for printing moves              // 3vs: increased value
//#define DEFAULT_ACCELERATION          800     // X, Y, Z and E acceleration for printing moves               // Artillery: default values
#define DEFAULT_RETRACT_ACCELERATION  10000   // E acceleration for retracts                                 // 3vs
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, Y, Z acceleration for travel (non printing) moves        // 3vs
 ...
 */
#define CLASSIC_JERK                                       // 3vs
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK  8.0                               // 3vs
  #define DEFAULT_YJERK  8.0                               // 3vs
...
#define DEFAULT_EJERK   10.0  // May be used by Linear Advance       // 3vs
 ...
 */
//#define S_CURVE_ACCELERATION                             // 3vs
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN                 // 3vs: enabled due to usage of Z min endstop as probe

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING                             // 3vs: enabled to use probe also for homing
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }                 // 3vs: probe offset

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 10                                  // 3vs: probe margin

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)                         // 3vs

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60)                       // 3vs
...
#define Z_MIN_PROBE_REPEATABILITY_TEST                     // 3vs
...
#define INVERT_X_DIR true                                 // 3vs
#define INVERT_Y_DIR true                                 // 3vs
#define INVERT_Z_DIR false                                // 3vs
...
#define INVERT_E0_DIR false                                // 3vs
...
#define X_BED_SIZE 300                                     // 3vs
#define Y_BED_SIZE 300                                     // 3vs

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -3                                       // 3vs
#define Y_MIN_POS -3                                       // 3vs
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 400                                      // 3vs
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define AUTO_BED_LEVELING_BILINEAR                       // 3vs
//#define AUTO_BED_LEVELING_UBL                            // 3vs
#define MESH_BED_LEVELING                                  // 3vs
 ...
 */
#define RESTORE_LEVELING_AFTER_G28                         // 3vs
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION                              // 3vs
  ...
  #define GRID_MAX_POINTS_X 5                              // 3vs
  ...
  #define MESH_INSET 10             // Set Mesh bounds as an inset region of the bed                         // 3vs
  #define GRID_MAX_POINTS_X 7       // Don't use more than 15 points per axis, implementation limited.       // 3vs
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  ...
  #define MESH_INSET 10          // Set Mesh bounds as an inset region of the bed                            // 3vs
  #define GRID_MAX_POINTS_X 5    // Don't use more than 7 points per axis, implementation limited.           // 3vs
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 */
#define Z_SAFE_HOMING                                      // 3vs

#if ENABLED(Z_SAFE_HOMING)
  #define Z_SAFE_HOMING_X_POINT 0  // (mm) X point for Z homing           // 3vs
  #define Z_SAFE_HOMING_Y_POINT 0  // (mm) Y point for Z homing           // 3vs
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) }            // 3vs
 ...
 */
#define EEPROM_SETTINGS       // Persistent storage with M500 and M501         // 3vs
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT    // Init EEPROM automatically on any errors.      // 3vs
  #define EEPROM_INIT_NOW     // Init EEPROM on first boot after a new build.  // 3vs
#endif
 ...
 */
#define NOZZLE_PARK_FEATURE                                // 3vs

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MIN_POS), 20 }         // 3vs
...
//
//#define ENCODER_PULSES_PER_STEP 2                          // 3vs
...
//
// #define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER      // 3vs
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN 5                                  // 3vs
  #define RGB_LED_G_PIN 4                                  // 3vs
  #define RGB_LED_B_PIN 6                                  // 3vs
  #define RGB_LED_W_PIN -1                                 // 3vs
