...
#define QUICK_HOME                            // If G28 contains XY do a diagonal move first       // 3vs
...
// @section bltouch
   ...
   */
  #define BLTOUCH_SET_5V_MODE                              // 3vs
   ...
   */
  #define BLTOUCH_HS_MODE true                             // 3vs
 ...
 */
#define Z_STEPPER_AUTO_ALIGN                               // 3vs
 ...
 */
#define INPUT_SHAPING_X                                    // 3vs
#define INPUT_SHAPING_Y                                    // 3vs
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING                            // 3vs
...
#define SET_PROGRESS_MANUALLY                              // 3vs
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  //#define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction
  #define M73_REPORT                    // Report M73 values to host         // 3vs
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'        // 3vs
  #define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol                    // 3vs
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>'        // 3vs
   ...
   */
  #define SDCARD_CONNECTION ONBOARD                        // 3vs
...
#define BABYSTEPPING                                       // 3vs
  ...
  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping           // 3vs
 ...
 */
#define LIN_ADVANCE                                        // 3vs
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.13        // (mm) Compression length applying to all extruders             // 3vs
  #endif
...
#define TX_BUFFER_SIZE 32                                  // 3vs

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 128                                 // 3vs
...
#define SERIAL_FLOAT_PRECISION 4                           // 3vs
 ...
 */
#define ADVANCED_PAUSE_FEATURE                             // 3vs
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.                                     // 3vs
  #define HOME_BEFORE_FILAMENT_CHANGE             // If needed, home before parking for filament change                                    // 3vs

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.          // 3vs
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       929        // (mA) RMS current. Multiply by 1.414 for peak current.
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)         // 3vs
 ...
 */
#define AUTO_REPORT_TEMPERATURES                           // 3vs
 ...
 */
#define AUTO_REPORT_POSITION                               // 3vs

/**
 * Include capabilities in M115 output
 */
#define EXTENDED_CAPABILITIES_REPORT                       // 3vs
#if ENABLED(EXTENDED_CAPABILITIES_REPORT)
  #define M115_GEOMETRY_REPORT                             // 3vs
#endif
...
#define M114_DETAIL           // Use 'M114` for details to check planner calculations              // 3vs
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE     // Report the new fan speed when changed by M106 (and others)        // 3vs
 ...
 */
#define HOST_ACTION_COMMANDS                               // 3vs
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback                      // 3vs
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS     // Send some status messages to the host as notifications          // 3vs
  #endif
